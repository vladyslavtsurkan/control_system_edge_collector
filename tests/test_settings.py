...
class TestSettings:
    def test_loads_from_env(self, env_vars: None) -> None:
        ...
        assert s.X_API_KEY_ID == "a3f8c2b1d4e0f900aabbccdd00112233"
        assert s.X_API_KEY_SECRET.get_secret_value() == "test-secret-b64url"
    ...
    def test_missing_required_var_raises(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        monkeypatch.delenv("X_API_KEY_ID", raising=False)
